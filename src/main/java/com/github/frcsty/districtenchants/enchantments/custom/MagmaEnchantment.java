...
public class MagmaEnchantment extends CustomEnchantment implements Listener {

    private final int id;

    public MagmaEnchantment(final int id) {
        super(id);
    ...
    public void onArmorEquip(final ArmorEquipEvent event) {
        if (event.getType() != ArmorType.LEGGINGS) return;
    ...
    public CustomEnchantmentTarget getCustomItemTarget() {
        return CustomEnchantmentTarget.ARMOR_LEGS;
    }
